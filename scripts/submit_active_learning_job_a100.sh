...
# Submission script that adds a job for active learning.
#
...
#SBATCH -J self_supervised_active_learning
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=self_supervised_active_learning.%j.out    # Standard output log
#SBATCH --error=self_supervised_active_learning.%j.err     # Standard error log
...
# Run the training.
poetry run kedro run --pipeline=active_learning --env=a100 "$@"
