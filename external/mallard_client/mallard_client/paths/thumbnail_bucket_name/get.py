...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_thumbnail_thumbnail_bucket_name_get_oapg(
        self,
...
class GetThumbnailThumbnailBucketNameGet(BaseApi):
    ...
    def get_thumbnail_thumbnail_bucket_name_get(
        ...
        return self._get_thumbnail_thumbnail_bucket_name_get_oapg(
