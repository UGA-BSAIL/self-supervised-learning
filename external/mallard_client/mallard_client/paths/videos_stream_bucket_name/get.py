...
# Path params
BucketSchema = schemas.StrSchema
...
request_path_bucket = api_client.PathParameter(
    name="bucket",
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_streamable_videos_stream_bucket_name_get_oapg(
        self,
...
class GetStreamableVideosStreamBucketNameGet(BaseApi):
    ...
    def get_streamable_videos_stream_bucket_name_get(
        ...
        return self._get_streamable_videos_stream_bucket_name_get_oapg(
