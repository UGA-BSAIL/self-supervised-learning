...
from mallard_client.model.body_query_artifacts_query_post import (
...
# Query params
ResultsPerPageSchema = schemas.IntSchema
PageNumSchema = schemas.IntSchema
...
# body param
SchemaForRequestBodyApplicationJson = BodyQueryArtifactsQueryPost

request_body_body_query_artifacts_query_post = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = QueryResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _query_artifacts_query_post_oapg(
        self,
    ...
    def _query_artifacts_query_post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = (
                request_body_body_query_artifacts_query_post.serialize(
                    body, content_type
                )
            )
...
class QueryArtifactsQueryPost(BaseApi):
    ...
    def query_artifacts_query_post(
        ...
        return self._query_artifacts_query_post_oapg(
            body=body,
