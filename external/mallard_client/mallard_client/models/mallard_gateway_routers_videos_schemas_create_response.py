...
class MallardGatewayRoutersVideosSchemasCreateResponse(BaseModel):
    """
    Response to use for video creation requests.  Attributes:     video_id: The ID of the video that was created.
    """  # noqa: E501

    video_id: ObjectRef = Field(alias="videoId")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of video_id
        if self.video_id:
            _dict["videoId"] = self.video_id.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "videoId": ObjectRef.from_dict(obj.get("videoId"))
                if obj.get("videoId") is not None
                else None
            }
        )
        return _obj
