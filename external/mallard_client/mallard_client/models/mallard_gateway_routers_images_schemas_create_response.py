...
class MallardGatewayRoutersImagesSchemasCreateResponse(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of image_id
        if self.image_id:
            _dict["imageId"] = self.image_id.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "imageId": ObjectRef.from_dict(obj.get("imageId"))
                if obj.get("imageId") is not None
                else None
            }
        )
        return _obj
