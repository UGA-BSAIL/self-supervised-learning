...
class RangeDate(BaseModel):
    ...
    min_value: Optional[date] = Field(default=None, alias="minValue")
    max_value: Optional[date] = Field(default=None, alias="maxValue")
    __properties: ClassVar[List[str]] = ["minValue", "maxValue"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {"minValue": obj.get("minValue"), "maxValue": obj.get("maxValue")}
        )
        return _obj
