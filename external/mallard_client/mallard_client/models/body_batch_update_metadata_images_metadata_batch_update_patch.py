...
class BodyBatchUpdateMetadataImagesMetadataBatchUpdatePatch(BaseModel):
    """
    BodyBatchUpdateMetadataImagesMetadataBatchUpdatePatch
    """  # noqa: E501

    metadata: UavImageMetadata
    images: List[ObjectRef]
    __properties: ClassVar[List[str]] = ["metadata", "images"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "metadata": UavImageMetadata.from_dict(obj.get("metadata"))
                if obj.get("metadata") is not None
                else None,
                "images": [
                    ObjectRef.from_dict(_item) for _item in obj.get("images")
                ]
