...
class BodyBatchUpdateMetadataVideosMetadataBatchUpdatePatch(BaseModel):
    """
    BodyBatchUpdateMetadataVideosMetadataBatchUpdatePatch
    """  # noqa: E501

    metadata: UavVideoMetadata
    videos: List[ObjectRef]
    __properties: ClassVar[List[str]] = ["metadata", "videos"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate(
            {
                "metadata": UavVideoMetadata.from_dict(obj.get("metadata"))
                if obj.get("metadata") is not None
                else None,
                "videos": [
                    ObjectRef.from_dict(_item) for _item in obj.get("videos")
                ]
