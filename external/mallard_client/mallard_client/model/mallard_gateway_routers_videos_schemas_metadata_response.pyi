...
class MallardGatewayRoutersVideosSchemasMetadataResponse(schemas.DictSchema):
    ...
    class MetaOapg:
        ...
        class properties:
            class metadata(schemas.ListSchema):
                class MetaOapg:
                    @staticmethod
                    def items() -> typing.Type["UavVideoMetadata"]:
                        return UavVideoMetadata
                def __new__(
                    cls,
                    _arg: typing.Union[
                        typing.Tuple["UavVideoMetadata"],
                        typing.List["UavVideoMetadata"],
                    ],
                ...
                def __getitem__(self, i: int) -> "UavVideoMetadata":
