...
def check_disk_space(
    ...
    total, used, free = (
        x / gib for x in shutil.disk_usage(Path.cwd())
    )  # bytes
...
def get_github_assets(
    repo="ultralytics/assets", version="latest", retry=False
):
    """
...
def attempt_download_asset(
    file, repo="ultralytics/assets", release="v8.1.0", **kwargs
):
    """
