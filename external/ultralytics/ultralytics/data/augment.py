...
class RandomPerspective:
    ...
    def apply_segments(self, segments, M):
        ...
        segments[..., 0] = segments[..., 0].clip(
            bboxes[:, 0:1], bboxes[:, 2:3]
        )
        segments[..., 1] = segments[..., 1].clip(
...
class RandomHSV:
    ...
    def __call__(self, labels):
        ...
        if self.hgain or self.sgain or self.vgain:
            ...
            cv2.cvtColor(
                im_hsv, cv2.COLOR_HSV2BGR, dst=img
            )  # no return needed
        return labels
...
class Format:
    ...
    def __init__(
        ...
        self.return_mask = (
            return_mask  # set False when training detection only
        )
