...
@pytest.mark.parametrize(
    ...
    [
        ...
        ([10.0, 10.0, 4.0, 6.0], [12.0, 13.0, 4.0, 6.0], 1.0 / 9.0),
        ([10.0, 10.0, 4.0, 6.0], [12.0, 7.0, 4.0, 6.0], 1.0 / 9.0),
        ([10.0, 10.0, 4.0, 6.0], [8.0, 7.0, 4.0, 6.0], 1.0 / 9.0),
        ([10.0, 10.0, 4.0, 6.0], [8.0, 13.0, 4.0, 6.0], 1.0 / 9.0),
        ([0.0, 0.0, 4.0, 6.0], [-2.0, -3.0, 4.0, 6.0], 1.0 / 9.0),
    ],
    ids=[
        "no_overlap",
        "perfect_overlap",
