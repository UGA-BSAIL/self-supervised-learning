...
class MultiViewDataset(Dataset):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            filter_views: If specified, it will only produce data from these
                specific views. Otherwise, it will produce data from all views.
            num_views: If specified, it will only select this many views to
                return. If there are more source views than this, it will
                select randomly. Otherwise, it will return all the views.
        ...
        self.__filter_views = filter_views
    ...
    def __getitem__(self, index: int) -> List[Tensor]:
        ...
        if self.__filter_views is not None:
            # Limit to specific views.
            frame_ids = [frame_ids[i] for i in self.__filter_views]

        if self.__num_views is not None and self.__num_views < len(frame_ids):
